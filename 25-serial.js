...
module.exports = function(RED) {
    ...
    RED.nodes.registerType("串口输出",SerialOutNode);
    ...
    RED.nodes.registerType("串口输入",SerialInNode);
    ...
    RED.nodes.registerType("串口请求", SerialRequestNode);
    ...
    RED.nodes.registerType("串口控制", SerialControlNode);
